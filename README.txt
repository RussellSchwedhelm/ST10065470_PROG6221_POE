# ST10065470_PROG6221_POE

This program is designed to enable users to create, display, scale, and delete recipes using C# programming. It offers a user-friendly interface that is easy to navigate, making it accessible to users of all levels of experience.

Two notable features of this program are the incorporation of animations for displaying messages or prompts, enhancing user engagement and providing progress updates. Another interesting aspect is the program's ability to handle both words and numbers for quantities. Users can input values like "one" or 1, and the program will react and produce the same output.
